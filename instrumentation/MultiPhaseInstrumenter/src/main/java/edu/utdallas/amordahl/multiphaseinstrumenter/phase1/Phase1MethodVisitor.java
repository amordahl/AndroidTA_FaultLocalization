 ...
 */
public class Phase1MethodVisitor extends MethodVisitor {

    private static Logger logger = LoggerFactory.getLogger(Phase1MethodVisitor.class);
    private static final Type OBJECT_TYPE = Type.getObjectType("java/lang/Object");
    private static String LOG_TRACKER = Type.getInternalName(LoggerHelper.class);
    private static int lineNumber;
    private String name;
    
    public Phase1MethodVisitor(MethodVisitor methodVisitor, String name) {
