...
public class LoggerMethodVisitor extends MethodVisitor {
	...
	public LoggerMethodVisitor(MethodVisitor methodVisitor, String name, Set<LineCoverageRecord> covered) {
	...
	public void visitLineNumber(int line, Label start) {
		...
		if (covered.contains(new LineCoverageRecord(this.name, Integer.valueOf(line)))) {
	...
	public void visitFieldInsn(int opcode, String owner, String name, String desc) {
		...
		if (toggle) {
			...
			case GETFIELD:
			case GETSTATIC:
				logger.info(String.format("%d instruction found on %s:%d", opcode, this.name, this.lineNumber));
	...
	private void logDataStructure() {
		...
		super.visitLdcInsn(this.lineNumber); // ..., OBJ, OBJ, name, size
		super.visitMethodInsn(INVOKESTATIC, LOG_TRACKER, "logCollectionSize", 
				"(Ljava/lang/Object;Ljava/lang/String;I)V", false); // ..., OBJ, OBJ
